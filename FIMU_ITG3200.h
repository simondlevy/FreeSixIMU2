...
public:
  ...
  void readGyroRaw(short  *_GyroXYZ);
  void readGyroRaw(short *_GyroX, short *_GyroY, short *_GyroZ);
  ...
  void readGyroRawCal(short *_GyroX, short *_GyroY, short *_GyroZ);
  void readGyroRawCal(short *_GyroXYZ);
